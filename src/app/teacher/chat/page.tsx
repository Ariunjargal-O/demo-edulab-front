  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      sender: "Б.Болормаа",
      content: "Маргаашийн математикийн хичээлийн талаар асууж болох уу?",
      time: "14:30",
      isOwn: false,
      avatar: "👩‍🎓",
    },
    {
      id: 2,
      sender: "Та",
      content: "Мэдээжээ! Юу тухайд асуух гэж байна вэ?",
      time: "14:32",
      isOwn: true,
      avatar: "👨‍🏫",
    },
    {
      id: 3,
      sender: "Б.Болормаа",
      content: "Интегралын тооцооллын талаар ойлгохгүй байгаа хэсэг байна",
      time: "14:33",
      isOwn: false,
      avatar: "👩‍🎓",
    },
    {
      ...
      sender: "Та",
      content:
        "За, дэлгэрэнгүй тайлбарлая. Ямар хэсэг нь хэцүү санагдаж байна вэ?",
      time: "14:35",
      isOwn: true,
      avatar: "👨‍🏫",
    },
